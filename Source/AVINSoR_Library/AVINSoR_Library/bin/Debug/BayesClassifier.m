...
classdef BayesClassifier
	...
	methods (Access = public)
		% * CONSTRUCTOR 			  *
		function obj = BayesClassifier(noOfCategories, inputValsArray)
		...
		% Sets Prior Probabilities for all categories
		function obj = setPriorProbs(obj, probabilities)
			obj.priories = probabilities;
            obj.risks = zeros(obj.noOfCats, obj.noOfInputVals);
		...
		function obj = plotLikelihoods(obj)
			plot(obj.likelihoods);
		end		
