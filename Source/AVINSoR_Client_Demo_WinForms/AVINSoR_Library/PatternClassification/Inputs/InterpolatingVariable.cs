    ...
    class InterpolatingVariable : Variable
    {
        ...
        public Variable XVar
        {
            ...
            protected set
            {
                ...
                if (value != null)
                {
                    ...
                    XVar.NewResultAvailable += XVarValueHasBeenUpdated;
                }
                else
                {
        ...
        public Variable YVar
        {
            ...
            protected set
            {
                _yVar = value;
                // subscribe to value change event 
                YVar.NewResultAvailable += YVarValueHasBeenUpdated;
            }
        }
        ...
        void EvaluateXandY()
        {
            ...
            if(NewValueAvailable != null) NewValueAvailable(this, new EventArgs());
            // reset x and y count
            XCount = 0;
            YCount = 0;
            // reset values
        ...
        public event EventHandler NewValueAvailable;
